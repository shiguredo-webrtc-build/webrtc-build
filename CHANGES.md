...
- 2026-02-26 [UPDATE] m146 ブランチのビルドエラーに対する対応
  ...
  - Unsafe Buffers のエラーに対応する
    - h265.patch, revive_proxy.patch で追加したコードについて unsafe-buffer-usage によりエラーが出るようになったため、コードを修正してエラーに対応する
