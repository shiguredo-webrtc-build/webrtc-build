...
def build_webrtc_ios(source_dir, build_dir, version_info, debug=False, gen=False, no_build=False):
...
def main():
    ...
    if args.op == 'build':
        ...
        with cd(BASE_DIR):
            ...
            # 特殊すぎるので別枠行き
            if args.target == 'ios':
                build_webrtc_ios(**build_webrtc_args, version_info=version_info)
